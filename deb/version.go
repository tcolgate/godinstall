...
// Version contains the componenet of a debian version
type Version struct {
...
// ParseVersion converts a string to the debian version components
...
// VersionCompare compares two version, returning 0 if equal, < 0 if a < b or
...
// MustParseVersion panic if debversion doesn't parse, Useful for writing tests
